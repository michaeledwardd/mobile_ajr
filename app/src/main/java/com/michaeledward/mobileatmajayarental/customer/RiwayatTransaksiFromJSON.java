...
public class RiwayatTransaksiFromJSON {
    ...
    public RiwayatTransaksiFromJSON(String nama_customer, String nama_driver, String nama_mobil, String nama_pegawai, String id_transaksi, String jenis_promo, double subtotal_all, String status_transaksi) {
